...
function _start(conf, resolve, reject) {
    ...
    /*
    master.once('ready', _onStart.bind(null, { resolve: resolve }));
    master.once('error', _onError.bind(null, { reject: reject }));
    if (master !== slave) {
        slave.once('ready', _onStart.bind(null, { resolve: resolve }));
        slave.once('error', _onError.bind(null, { reject: reject }));
    }
    */
