...
class SharedObject extends EventEmitter {
    ...
    add(name, value) {
        ...
        if (!this._props[name] || typeof this._props[name].value !== 'object') {
            return false;
        }
        this._props[name].value[value] = true;
        this._set(name, this._props[name].value[value]);
        return true;
    }
    ...
    del(name, value) {
        ...
        if (this._props[name].value[value] === undefined) {
            return false;
        }
        if (!this._props[name] || typeof this._props[name].value !== 'object') {
            return false;
        }
        delete this._props[name].value[value];
        this._set(name, this._props[name].value[value]);
        return true;
    }
